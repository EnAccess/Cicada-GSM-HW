...
- **By opening the issue for discussion:** If you believe that you have found a new bug in this project, you should report it by creating a new issue in the [issue tracker](https://github.com/EnAccess/Cicada-GSM-HW/issues).
...
- When opening a new issue in the [issue tracker](https://github.com/EnAccess/Cicada-GSM-HW/issues/new/choose), users will be presented with a template that should be filled in.
